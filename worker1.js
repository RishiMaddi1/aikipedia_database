...
Keep answers concise but informative. Use markdown formatting when needed.`
    ...
    if (req.method === 'POST' && new URL(req.url).pathname === '/chat') {
      try {
        ...
        // 🔸 Step 1: Check credits using Supabase Edge Function
        ...
        // 🔸 Step 3: Call OpenRouter for AI response
        ...
        // 🔸 Step 4: Calculate cost and deduct credits using Supabase Edge Function
