...
if (req.method === 'POST' && new URL(req.url).pathname === '/chat') {
  try {
    ...
    const aiResponse = await fetch("https://openrouter.ai/api/v1/chat/completions", {
      method: "POST",
      headers: {
        Authorization: `Bearer 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`,
        "Content-Type": "application/json",
...
await fetch(`${SUPABASE_EDGE_URL}/subtract_credits`, {
  method: "POST",
  headers: {
    "Authorization": `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInhhZmp3bG5hY3diZ2h3amVpYndjIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDYwODQ1MDcsImV4cCI6MjA2MTY2MDUwN30.mKJCQ2WR3YHSYRvOawjCeSVSv4OYIpV06OsSa1bJ6UA`,
    "Content-Type": "application/json"
  },
